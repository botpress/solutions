 ...
 * For example, `data/bots/MY_BOT/config/delegate-bot-conversation.json` will be used by MY_BOT, while `data/global/config/delegate-bot-conversation.json` will be used for all others
 */
