...
export default async (bp: typeof sdk) => {
   ...
   * Your API will be available at `http://localhost:3000/api/v1/bots/BOT_NAME/mod/extended-choice-skill`
   * Just replace BOT_NAME by your bot ID
   */
  /*const router = bp.http.createRouterForBot('extended-choice-skill')

  // Link to access this route: http://localhost:3000/api/v1/bots/BOT_NAME/mod/extended-choice-skill/my-first-route
  router.get('/my-first-route', async (req, res) => {
     ...
     */
    /*
    const config = await bp.config.getModuleConfigForBot('extended-choice-skill', botId)
