 ...
 * For example, `data/bots/MY_BOT/config/custom-web-component-module.json` will be used by MY_BOT, while `data/global/config/custom-web-component-module.json` will be used for all others
 */
